...
export enum I18nKey {
  ...
  CONVERSATION$LOAD_ERROR_TITLE = "CONVERSATION$LOAD_ERROR_TITLE",
  CONVERSATION$LOAD_ERROR_DESCRIPTION = "CONVERSATION$LOAD_ERROR_DESCRIPTION",
  CONVERSATION$RETRY_LOAD = "CONVERSATION$RETRY_LOAD",
